...
output "frontend_cluster_certificate_authority_data" {
...
output "backend_cluster_certificate_authority_data" {
  value = module.backend_eks.cluster_certificate_authority_data
}
